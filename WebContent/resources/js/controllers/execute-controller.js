	...
	$("#deploy").button().click(function(){
		...
		deploy(candidatos,function(computSystem){
			...
			if(system != null){
				...
				$("#linkComputacional").attr("href","/HPC-Shelf-FrontEnd/resources/file/system.xml").attr("download","system.xml").tooltip();
			}
...
function resolved(listCandidates){
	...
	if(candidatos != null){
		...
		for(var i = 0; i < candidatos.value.candidate.length; i++){
			...
			console.log(can);
			$("#candidatos").append("<li id='"+i+"'><div class='panel panel-default'><div class='panel-heading' style='background-color:#25BFE1'><h4 class='panel-title'><a data-toggle='collapse' href='#collapse"+i+"'><b>"+can.ccName+"</b></a></h4>"+
		      "</div><div id='collapse"+i+"' class='panel-collapse collapse'><div class='panel-body'>"+show(can)+"</div></div></div></li>");	
		}			
		$("#linkCandidates").attr("href","/HPC-Shelf-FrontEnd/resources/file/candidates.xml").attr("download","candidates.xml").tooltip();
